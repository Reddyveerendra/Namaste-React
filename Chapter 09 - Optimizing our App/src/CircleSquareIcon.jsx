    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-4">
          <div class="w-[20px] h-[20px] border-2 border-solid border-red-500 flex items-center justify-center">
...
const CircleSquareIconGreen = () => {
  return (
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-4">
          <div class="w-[20px] h-[20px] border-2 border-solid border-green-500 flex items-center justify-center">
